...
/**
 * Servlet implementation class bookingByRoomId
 */
@WebServlet("/bookingByRoomId")
public class bookingByRoomId extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("-->>");
		try {
			bList=dao.getBookingRMId( Integer.parseInt(request.getParameter("RMId")) );
			if(bList.size()>0)  {
