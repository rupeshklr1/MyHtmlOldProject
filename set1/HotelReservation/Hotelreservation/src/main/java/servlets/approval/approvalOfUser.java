...
/**
 * Servlet implementation class approvalOfUser
 */
@WebServlet("/approvalOfUser")
public class approvalOfUser extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("-->>");
		try {
			aList=dao.getMyApprovalReq(Integer.parseInt(request.getParameter("id")));
			if(aList.size()>0)  {
